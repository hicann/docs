...
### AI Core
- input0 x: bfloat16,float4_e1m2,float4_e2m1,float8_e4m3fn,float8_e5m2,float16,float32,hifloat8,int4,int8
- input1 weight: bfloat16,float4_e1m2,float4_e2m1,float8_e4m3fn,float8_e5m2,float16,float32,hifloat8,int4,int8,int32
- input2 bias: bfloat16,float16,float32,int32
- input3 scale: bfloat16,float8_e8m0,float32,int64,uint64
- input4 offset: float32
- input5 antiquant_scale: bfloat16,float8_e8m0,float16
- input6 antiquant_offset: bfloat16,float16
- input7 group_list: int64
- input8 per_token_scale: float8_e8m0,float32
