...
### AI Core
- input0 x: bfloat16,float16,float32,int4,int8
- input1 weight: bfloat16,float16,float32,int4,int8
- input2 bias: bfloat16,float16,float32,int32
- input3 scale: bfloat16,float32,uint64
...
- input8 per_token_scale: float32
