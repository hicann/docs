...
- input2 gamma: float16,float32
- input3 beta: float16,float32
- input4 bias: float16,float32
- input5 scales1: float16,float32
- input6 scales2: float16,float32
- input7 zero_points1: float16,float32
- input8 zero_points2: float16,float32
- output0 y1: int8
- output1 y2: int8
- output2 x: float16,float32
- output3 layernorm_res: float16,float32
