...
### AI Core
- input0 token_x: bfloat16,float8_e4m3fn,hifloat8,int8
- input1 weight_dq: bfloat16,float8_e4m3fn,hifloat8,int8
- input2 weight_uq_qr: bfloat16,float8_e4m3fn,hifloat8,int8
- input3 weight_uk: bfloat16
- input4 weight_dkv_kr: bfloat16,float8_e4m3fn,hifloat8,int8
- input5 rmsnorm_gamma_cq: bfloat16
- input6 rmsnorm_gamma_ckv: bfloat16
- input7 rope_sin: bfloat16
- input8 rope_cos: bfloat16
- input9 kv_cache: bfloat16,float8_e4m3fn,hifloat8,int8
- input10 kr_cache: bfloat16,int8
- input11 cache_index: int64
- input12 dequant_scale_x: float8_e8m0,float32
- input13 dequant_scale_w_dq: float8_e8m0,float32
- input14 dequant_scale_w_uq_qr: float8_e8m0,float32
- input15 dequant_scale_w_dkv_kr: float8_e8m0,float32
...
- output0 query: bfloat16,float8_e4m3fn,hifloat8,int8
- output1 query_rope: bfloat16
- output2 kv_cache: bfloat16,float8_e4m3fn,hifloat8,int8
- output3 kr_cache: bfloat16,int8
- output4 dequant_scale_q_nope: float32
- output5 query_norm: bfloat16,float8_e4m3fn,hifloat8,int8
- output6 dequant_scale_q_norm: float8_e8m0,float32
