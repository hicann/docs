...
- input1 x_scale: float8_e8m0,float32
- input2 group_list: int64
- input3 weight: float4_e1m2,float4_e2m1,float8_e4m3fn,float8_e5m2,hifloat8,int8
- input4 weight_scale: bfloat16,float8_e8m0,float16,float32
- input5 weight_assist_matrix: float32
- input6 bias: float32
- input7 smooth_scale: float32
- output0 y: float4_e1m2,float4_e2m1,float8_e4m3fn,float8_e5m2,hifloat8,int8
