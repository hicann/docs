...
Apply mul operation for each tensor in tensor list with a scalar in manner of element-wise
...
- y: A tensor list which store the tensors whose value are mul by the scalar,
