...
该融合将符合图融合pattern的Mul + ReduceSumD/ReduceSum（仅Ascend 950PR&950DT系列产品支持） + Sub这几个小算子融合成ConfusionSoftmaxGrad算子。
...
- Ascend 950PR&950DT系列产品场景下，ReduceSum的属性keep\_dims为False时，当前融合规则不生效。
- Ascend 950PR&950DT系列产品场景下，ReduceSum的输入axis不是const节点时，当前融合规则不生效。
