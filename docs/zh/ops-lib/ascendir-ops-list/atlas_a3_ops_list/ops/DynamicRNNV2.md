...
- input1 weight_input: float16,float32
- input2 weight_hidden: float16,float32
- input3 b: float16,float32
- input4 seq_length: float16,float32
- input5 init_h: float16,float32
- input6 init_c: float16,float32
- input7 wci: float16,float32
- input8 wcf: float16,float32
- input9 wco: float16,float32
- input10 mask: uint8
