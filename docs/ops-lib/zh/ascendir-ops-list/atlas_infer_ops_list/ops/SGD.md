...
### AI Core
- input0 parameters: float16,float32
- input1 gradient: float16,float32
- input2 learning_rate: float16,float32
- input3 accum: float16,float32
- input4 momentum: float16,float32
- input5 stat: float16,float32
- output0 parameters: float16,float32
