...
### AI Core
- input0 x: bfloat16,bool,double,float8_e4m3fn,float8_e5m2,float8_e8m0,float16,float32,hifloat8,int8,int16,int32,int64,uint8,uint16,uint32
- input1 paddings: int32,int64
- output0 y: bfloat16,bool,double,float8_e4m3fn,float8_e5m2,float8_e8m0,float16,float32,hifloat8,int8,int16,int32,int64,uint8,uint16,uint32
### AI CPU
