...
- 工具自动收集：在Host服务上，使用[asys](https://gitcode.com/cann/oam-tools/blob/9.2.0/docs/zh/asys/asys_functions_and_restrictions.md)工具**收集所有故障相关信息**，包括安装版本信息、Device健康状态信息、dump文件、算子编译信息、全量日志文件等。
...
3. trace日志的默认路径为Host服务器的$HOME/ascend/atrace/目录。将日志文件移动至err\_log\_info目录下:
