...
Apply add operation for each tensor in tensor list with a list of scalar in manner
...
- y: A tensor list which store the tensors whose value are add by the scalars in scalar list
