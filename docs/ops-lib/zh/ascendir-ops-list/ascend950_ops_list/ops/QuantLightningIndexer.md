...
### AI Core
- input0 query: float8_e4m3fn,hifloat8,int8
- input1 key: float8_e4m3fn,hifloat8,int8
- input2 weights: bfloat16,float16
- input3 query_dequant_scale: float16,float32
- input4 key_dequant_scale: float16,float32
