...
### AI Core
- input0 x1: bfloat16,float4_e2m1,float8_e4m3fn,float8_e5m2,float16,hifloat8,int8
- input1 x2: bfloat16,float4_e2m1,float8_e4m3fn,float8_e5m2,float16,hifloat8,int4,int8
- input2 bias: bfloat16,float16,float32,int32
- input3 x3: bfloat16,float16,float32
- input4 antiquant_scale: bfloat16,float16,float32
- input5 antiquant_offset: bfloat16,float16,float32
- input6 dequant_scale: bfloat16,float8_e8m0,float16,float32,int64,uint64
- input7 pertoken_scale: bfloat16,float8_e8m0,float16,float32
- input8 comm_quant_scale_1: bfloat16,float16,float32
- input9 comm_quant_scale_2: bfloat16,float16,float32
