...
### AI Core
- input0 x1: bfloat16,bool,double,float16,float32,int8,int32,int64,uint8,uint64
- input1 x2: bfloat16,bool,double,float16,float32,int8,int32,int64,uint8,uint64
- output0 y: bool
### AI CPU
