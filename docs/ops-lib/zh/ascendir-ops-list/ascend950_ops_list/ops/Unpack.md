...
### AI Core
- input0 x: bfloat16,bool,complex32,float16,float32,int8,int16,int32,int64,uint8,uint16,uint32,uint64
- output0 y: bfloat16,bool,complex32,float16,float32,int8,int16,int32,int64,uint8,uint16,uint32,uint64
### AI CPU
