...
Must be one of the following types: float32, float16, int8, int16, uint16, uint8, int32, int64, uint32, uint64, bool, double, resource, string, complex64, complex128, qint16, quint16, qint8, quint8, qint32.
