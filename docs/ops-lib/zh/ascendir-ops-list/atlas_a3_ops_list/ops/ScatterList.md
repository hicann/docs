...
### AI Core
- input0 var: bfloat16,float16,float32,int8,int16,int32,uint8,uint16,uint32
- input1 indice: int32,int64
- input2 updates: bfloat16,float16,float32,int8,int16,int32,uint8,uint16,uint32
- input3 mask: uint8
- output0 var: bfloat16,float16,float32,int8,int16,int32,uint8,uint16,uint32
