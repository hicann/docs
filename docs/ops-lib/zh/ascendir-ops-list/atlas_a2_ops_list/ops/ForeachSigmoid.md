...
Apply sigmoid operation for each tensor in a tensor list in manner of element-wise
...
- y: A tensor list which store the tensors whose value are the sigmoid value of the x
