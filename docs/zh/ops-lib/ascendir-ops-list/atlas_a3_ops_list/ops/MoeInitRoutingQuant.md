...
- expanded_x: A 2D Tensor. Type is:Int8. The data type must be the same as that of x.
...
- scale: Required parameter. Type is:Float.
- offset: Required parameter. Type is:Float.
