...
- input1 value: bfloat16,bool,float16,float32,int8,int32,int64,uint16,uint32,uint64
- output0 y: bfloat16,bool,float16,float32,int8,int32,int64,uint16,uint32,uint64
### AI CPU
- input0 dims: int32,int64
