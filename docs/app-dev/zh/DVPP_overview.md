...
<!-- npu="310b" id1 -->
**图 1**  图像/视频数据处理  
![](figures/图像-视频数据处理.png "图像-视频数据处理")
<!-- end id1 -->
...
- **视频解码、缩放**
    ...
    **图 2**  视频解码、缩放使用场景图  
    ![](figures/视频解码-缩放使用场景图.png "视频解码-缩放使用场景图")
...
- **图片解码、缩放、格式转换**
    ...
    **图 3**  图片解码、缩放、格式转换使用场景图  
    ![](figures/图片解码-缩放-格式转换使用场景图.png "图片解码-缩放-格式转换使用场景图")
...
- **抠图、缩放、格式转换**
    ...
    **图 4**  抠图、缩放、格式转换使用场景图  
    ![](figures/抠图-缩放-格式转换使用场景图.png "抠图-缩放-格式转换使用场景图")
