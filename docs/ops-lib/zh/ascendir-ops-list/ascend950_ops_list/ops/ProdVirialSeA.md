...
### AI Core
- input0 net_deriv: float16,float32
- input1 in_deriv: float16,float32
- input2 rij: float16,float32
- input3 nlist: int32
- input4 natoms: int32
- output0 virial: float16,float32
- output1 atom_virial: float16,float32
