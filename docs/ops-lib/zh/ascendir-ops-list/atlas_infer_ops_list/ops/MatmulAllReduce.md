...
### AI Core
- input0 x1: float16,int8
- input1 x2: float16,int8
- input2 bias: float16,int32
- input3 x3: float16
- input4 antiquant_scale: float16
- input5 antiquant_offset: float16
- input6 dequant_scale: float16,int64,uint64
- input7 pertoken_scale: float32
- input8 comm_quant_scale_1: float16
- input9 comm_quant_scale_2: float16
- output0 y: float16
