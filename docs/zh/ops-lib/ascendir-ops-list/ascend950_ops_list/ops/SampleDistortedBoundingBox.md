...
- min_object_covered: An optional float, default is `[0.1f]`, The cropped area of the image must contain at least
...
- aspect_ratio_range: An optional list of `floats`. Defaults to `[0.75, 1.33]`, the cropped area of the image must have an aspect
