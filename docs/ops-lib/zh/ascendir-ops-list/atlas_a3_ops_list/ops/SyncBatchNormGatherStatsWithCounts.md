...
### AI Core
- input0 mean_all: bfloat16,float16,float32
- input1 invert_std_all: bfloat16,float16,float32
- input2 count_all: bfloat16,float16,float32
- input3 mean_broadcast: bfloat16,float16,float32
- input4 count_sum: bfloat16,float16,float32
- input5 running_var: bfloat16,float16,float32
- output0 invert_std: bfloat16,float16,float32
- output1 running_var_update: bfloat16,float16,float32
