...
msaicerr工具的功能及约束请参见[msaicerr工具功能及约束](https://gitcode.com/cann/oam-tools/blob/9.2.0/docs/zh/msaicerr/msaicerr_functions_and_restrictions.md)，环境准备请参见[msaicerr工具环境准备](https://gitcode.com/cann/oam-tools/blob/9.2.0/docs/zh/msaicerr/msaicerr_environment_preparation.md)。
...
2. 使用**msaicerr工具快速定位AI Core Error问题的关键原因**。
    ...
    **表 1**  关键信息
    ...
    msaicerr工具的其它参数及功能请参见[msaicerr工具功能及约束](https://gitcode.com/cann/oam-tools/blob/9.2.0/docs/zh/msaicerr/msaicerr_functions_and_restrictions.md)。
