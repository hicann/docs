...
The fusion operator of Gelu activation function and quantum quantization.

## Inputs

- x: A tensor. Type is DT_FLOAT32, DT_FLOAT16, DT_BF16.
Shape supports at least 2 dimensions (M,K1), and at most 8 dimensions.
- input_scale: An optional tensor. When quant_mode is "static",it is a required tensor.
...
- input_offset: An optional tensor. It is an optional input when quant_mode is "static".
...
- y: A tensor. Type is DT_INT8, DT_FLOAT8_E4M3_FN, DT_FLOAT8_E5M2, DT_HIFLOAT8. Shape size is the same as x.
- out_scale: A tensor. Type is DT_FLOAT32. Represents Scale used for quantization. The value is
...
- approximate: Optional string parameter. Which formula used for activation computation.
Type is String. The value must be none or tanh. Defaults to none.
- quant_mode: Optional string parameter. Which formula used for quantized computation
Type is String. The value must be dynamic or static. Defaults to dynamic.
- dst_type: Optional int32 parameter, specifying the output data type.
    The value range is [DT_INT8, DT_FLOAT8_E4M3FN, DT_FLOAT8_E5M2, DT_HIFLOAT8]. Defaults to DT_INT8.
- round_mode: Optional string parameter, specifying the cast type.
...
- input1 input_scale: bfloat16,float16,float32
- input2 input_offset: bfloat16,float16,float32
- output0 y: float8_e4m3fn,float8_e5m2,hifloat8,int8
- output1 out_scale: float32
