...
### AI Core
- input0 x: float4_e2m1,float8_e4m3fn,float8_e5m2,hifloat8,int8
- input1 w: float4_e2m1,float8_e4m3fn,float8_e5m2,hifloat8,int8
- input2 scale: bfloat16,float8_e8m0,float32
- input3 bias: bfloat16
- input4 pertoken_scale: float8_e8m0,float32
