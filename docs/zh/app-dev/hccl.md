...
- 样例介绍
    ...
    用户可以点击[Link](https://gitcode.com/cann/hcomm/tree/9.2.0/examples/01_communicators/03_one_device_per_pthread)获取完整样例代码，该样例基于root节点信息创建通信域，在一个进程中管理一个AI Server，其中每个NPU设备由一个线程进行管理，主要包含以下功能点：
