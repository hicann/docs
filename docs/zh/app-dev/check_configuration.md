...
2. 检查AIPP配置。
    ...
    如果AIPP配置错误可能导致模型推理的输入数据不准确，需要参见[《ATC离线模型编译工具》](https://gitcode.com/cann/ge/blob/9.2.0/docs/zh/user_guides/atc_tools/README.md)中的“高级功能 \> 开启AIPP”章节检查AIPP配置，如有不正确的AIPP配置，修改正确后，重新转换模型，再重新推理。
