...
REG_OP(InplaceApplyAdagradDA)
    ...
    .OP_END_FACTORY_REG(InplaceApplyAdagradDA)
```

## Brief

Updates "var" according to the ApplyAdagradDA scheme . 
...
- input1 gradient_accumulator: float16,float32
- input2 gradient_squared_accumulator: float16,float32
- input3 grad: float16,float32
- input4 lr: float16,float32
- input5 l1: float16,float32
- input6 l2: float16,float32
- input7 global_step: int32,int64
- output0 var: float16,float32
- output1 gradient_accumulator: float16,float32
- output2 gradient_squared_accumulator: float16,float32
