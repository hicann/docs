...
- input1 then: float16,float32,int8,int32,int64,uint8
- input2 else: float16,float32,int8,int32,int64,uint8
- output0 result: float16,float32,int8,int32,int64,uint8
### AI CPU
- input0 condition: bool
