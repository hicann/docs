...
Applies sparse "updates" to individual values or slices in a variable reference using the "min" operation.
...
### AI Core
- input0 var: bfloat16,bool,float16,float32,int8,int16,int32,int64,uint32,uint64
- input1 indices: int32,int64
- input2 updates: bfloat16,bool,float16,float32,int8,int16,int32,int64,uint32,uint64
- output0 var: bfloat16,bool,float16,float32,int8,int16,int32,int64,uint32,uint64
### AI CPU
