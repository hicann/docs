...
Apply log1p operation for each tensor in a tensor list in manner of element-wise
...
- y: A tensor list which store the tensors whose value are the log1p value of the x
