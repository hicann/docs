...
- output_dim: A required int, specifying the number of output channels,
must be greater than 0.
- group_size: A required int, specifying the number of groups to encode
position-sensitive score maps, must be within the range (0, 128).
- spatial_scale: A required float, scaling factor for mapping the input
